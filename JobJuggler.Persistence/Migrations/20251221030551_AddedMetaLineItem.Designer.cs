...
namespace JobJuggler.Persistence.Migrations
{
    ...
    [Migration("20251221030551_AddedMetaLineItem")]
    partial class AddedMetaLineItem
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("JobJuggler.Domain.MetaModels.Contact", b =>
                {
                    ...
                    b.HasIndex("DeletedById")
                        .HasDatabaseName("IX_contacts_deleted_by_id");
            ...
            modelBuilder.Entity("JobJuggler.Domain.MetaModels.MetaInvoice", b =>
                {
                    ...
                    b.HasIndex("CreatedById")
                        .HasDatabaseName("IX_meta_invoices_created_by_id");

                    b.HasIndex("DeletedById")
                        .HasDatabaseName("IX_meta_invoices_deleted_by_id");

                    b.HasIndex("LastModifiedById")
                        .HasDatabaseName("IX_meta_invoices_last_modified_by_id");
            ...
            modelBuilder.Entity("JobJuggler.Domain.MetaModels.MetaLineItem", b =>
                {
                    ...
                    b.HasIndex("CreatedById")
                        .HasDatabaseName("IX_meta_line_items_created_by_id");

                    b.HasIndex("DeletedById")
                        .HasDatabaseName("IX_meta_line_items_deleted_by_id");

                    b.HasIndex("InvoiceId");

                    b.HasIndex("LastModifiedById")
                        .HasDatabaseName("IX_meta_line_items_last_modified_by_id");
            ...
            modelBuilder.Entity("JobJuggler.Domain.MetaModels.Subscription", b =>
                {
                    ...
                    b.HasIndex("CreatedById")
                        .HasDatabaseName("IX_subscriptions_created_by_id");

                    b.HasIndex("DeletedById")
                        .HasDatabaseName("IX_subscriptions_deleted_by_id");

                    b.HasIndex("LastModifiedById")
                        .HasDatabaseName("IX_subscriptions_last_modified_by_id");
